...
#define WLAN_API_VERSION 1 
 
// maximum length of name, in characters 
#define WLAN_MAX_NAME_LENGTH 100 //L2_PROFILE_MAX_NAME_LENGTH 
...
// the maximum data size in one PSD IE data entry, in bytes 
#define DOT11_PSD_IE_MAX_DATA_SIZE 230       // 255 - 6 - 2 - FORMAT ID 
// the maximum number of data entries 
#define DOT11_PSD_IE_MAX_ENTRY_NUMBER 10     // 10 enties at most     
...
#define WLAN_AVAILABLE_NETWORK_INCLUDE_ALL_HIDDEN_PROFILES  0x00000002 
